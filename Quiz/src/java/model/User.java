...
public class User {
    ...
    public User(String username, int roleId, String email, String password, String role, String phoneNumber, String date, String place) {
    ...
    public String toString() {
        return "User{" + "userId=" + userId + ", userName=" + userName + ", roleId=" + roleId + ", email=" + email + ", password=" + password + ", role=" + role + ", phoneNumber=" + phoneNumber + ", avatar=" + avatar + ", fullName=" + fullName + ", Dob=" + Dob + '}';
    }
